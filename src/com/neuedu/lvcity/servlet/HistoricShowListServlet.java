...
/**
 * Servlet implementation class HistoricShowListServlet
 */
@WebServlet("/HistoricShowListServlet")
public class HistoricShowListServlet extends HttpServlet {
     ...
     */
    public HistoricShowListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//设置会话对象
		se.setAttribute("historiclelist", list);
